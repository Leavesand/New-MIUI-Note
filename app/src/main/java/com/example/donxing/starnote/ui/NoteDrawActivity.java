  ...
  /*
     ...
     */
        ...
        */
        ...
        SpannableString spannableString = ContentToSpannableString.Content2SpanStr(NoteDrawActivity.this, content);
        ...
        FloatingActionButton btn_note_draw = findViewById(R.id.button_note_draw_save);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.show_menu_delete) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(NoteDrawActivity.this);
            ...
            Intent intent = new Intent(NoteDrawActivity.this,AlarmReceiver.class);
            intent.putExtra("NoteContent",note.getContent());
            pi = PendingIntent.getBroadcast(NoteDrawActivity.this,0,intent,0);
